...
- `npm.cmd test`完整通过；发布构建和项目检查通过。扩展ZIP共14项，7个关键文件与源码一致，SHA-256为`9CB40F5CB83691CE6CE1624DE325920F8BA7C4C754B2D19A61DE5EE74F659E4F`。
- 需要重新加载0.6.15扩展，并使用无主图的10件JSON先验收是否恢复10/10成功。
